...
class ServicioPsicologo extends Model
{
    ...
    {
        return $this->belongsTo('App\ModalidadServicio', 'id_modalidad_servicio', 'id_modalidad_servicio');
    }
    ...
    {
        return $this->hasMany('App\Reserva', 'id_servicio_psicologo', 'id_servicio_psicologo');
    }
    ...
    {
        return $this->hasMany('App\ServicioPrevision', 'id_servicio_psicologo', 'id_servicio_psicologo');
    }
}
