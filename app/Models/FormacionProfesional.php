...
class FormacionProfesional extends Model
{
    ...
    {
        return $this->hasMany('App\Models\FormacionEspecialidad', 'id_formacion_profesional', 'id_formacion_profesional');
    }
    ...
    {
        return $this->hasMany('App\Models\FormacionEtarium', 'id_formacion_profesional', 'id_formacion_profesional');
    }
}
