...
class ModalidadServicio extends Model
{
    ...
    {
        return $this->belongsTo('App\PrecioModalidad', 'id_precio_modalidad', 'id_precio_modalidad');
    }
    ...
    {
        return $this->hasMany('App\ServicioPsicologo', 'id_modalidad_servicio', 'id_modalidad_servicio');
    }
}
